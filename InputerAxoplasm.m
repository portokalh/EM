clear all
train=1;%1 to generate new inputs for training NN
pos = 1;
dog=0;
prompt = 'Axons:';
...
genotype='CVN';
genotype2='cvn';
for imindex=1:1 %numel(index)
    imindex

    %nos1
filein=['/Users/alex/Desktop/andy/ematpathlab/FORNIX/NOS/140313_1_NOS_f/7100/140313_NOS_0' char(index{imindex}) '.TIF']; %'/Users/alex/Desktop/andy/train_140228_1_NOS_7100.TIF'; %
    %nos2
    %cvn1
    
 filein=['/Users/alex/Desktop/andy/ematpathlab/' fiber '/' genotype '/' runno '_' genotype '_f/7100/' runno '_' genotype '_0' char(index{imindex}) '.TIF']; %'/Users/alex/Desktop/andy/train_140228_1_NOS_7100.TIF'; %
 %cvn2
 filein=['/Users/alex/Desktop/andy/ematpathlab/' fiber '/' genotype '/' runno '_' genotype2 '_f/7100/' runno '_' genotype '_0' char(index{imindex}) '.TIF']; %'/Users/alex/Desktop/andy/train_140228_1_NOS_7100.TIF'; %
...
% img = imerode(img,ker);
close all
[img, rawimg_small,init_no] = mommy_axoplasm(filein,mag);
